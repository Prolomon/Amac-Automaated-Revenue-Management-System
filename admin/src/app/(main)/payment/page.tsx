...
export default function PaymentPage() {
  ...
  const handlePayNow = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        addToast(
          "success",
          "Payment initiated successfully. Please check your email for further instructions.",
        );
  ...
  const principal = Number(paymentData?.amount);
  ...
  const totalAmount = subtotal + penalty - Number(paymentData?.discount || 0);
    ...
    <main className="bg-[#F5F7F5] font-['Inter',sans-serif] text-[#0E1F17]">
        ...
        <div className="relative mx-auto grid w-full max-w-7xl gap-10 px-4 py-14 md:grid-cols-2 md:items-center md:px-6 md:py-20">
          <div>
            ...
            <p className="mt-4 max-w-lg text-base leading-relaxed text-white/70 md:text-lg">
              Pay your tenement and business rates securely. Multiple payment
              options available with instant confirmation.
            </p>
            ...
            <div className="rounded-2xl border border-white/10 bg-[#0E1F17]/40 p-6">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-['Space_Grotesk',sans-serif] text-sm font-semibold text-white">
                      Easy Payment
                    </p>
                ...
                <div className="rounded-xl border border-[#1B9E5A]/30 bg-[#1B9E5A]/12 p-3">
                  <p className="inline-flex items-center gap-1 text-xs font-medium text-[#8FE0B4]">
                    <CreditCard className="h-5 w-5 text-[#8FE0B4]" /> Your
                    payment is protected with bank-level security encryption
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-14 md:px-6">
        <div className="mb-10 text-center">
          <span className="font-['JetBrains_Mono',monospace] text-xs uppercase tracking-wide text-[#158049]">
            Start Payment
          </span>
          <h2 className="mt-2 font-['Space_Grotesk',sans-serif] text-2xl font-bold text-[#0E1F17] md:text-3xl">
            Enter Your Details
          </h2>
          <p className="mx-auto mt-2 max-w-2xl text-sm text-[#5B6B62] md:text-base">
            Provide your phone number, member ID, or payment ID to view and pay
            your bills.
          </p>
        </div>
          ...
          <div className="rounded-[20px] border border-[#E1E7E2] bg-white p-8 shadow-sm">
            <div className="space-y-6">
              <div>
                <label
                  htmlFor="identifier"
                  className="mb-2 block text-sm font-semibold text-[#0E1F17]"
                >
                ...
                <div className="flex w-full items-center gap-2">
                  ...
                  <button
                    onClick={getPayNow}
                    className="cursor-pointer rounded-xl border border-transparent bg-[#158049] px-3 py-3 text-white transition hover:bg-[#0B3B26] focus:ring-2 focus:ring-[#1B9E5A]/40"
                  >
              ...
              {showPayButton && (
                <div className="animate-fade-in">
                  {status ? (
                    <div className="mb-4 rounded-2xl border border-[#1B9E5A]/25 bg-[#E4F5EB]/60 p-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-xs text-[#5B6B62]">
                            We found your pending payment. Click the button
                    ...
                    <div className="mb-4 rounded-2xl border border-red-200 bg-red-50 p-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-xs text-[#5B6B62]">
                            We could not find a pending payment with the
                            provided details.
                          </p>
                        </div>
                      </div>
                  ...
                  {status && (
                    <button
                      className="inline-flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl bg-[#0B3B26] px-5 py-3 text-sm font-semibold text-white transition-transform hover:-translate-y-0.5"
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pb-14 md:px-6">
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-[20px] border border-[#E1E7E2] bg-white p-5 shadow-sm">
            ...
            <h3 className="mt-2 font-['Space_Grotesk',sans-serif] text-sm font-semibold text-[#0E1F17]">
              Card & Bank Transfer
            </h3>
            <p className="mt-1 text-xs text-[#5B6B62]">
              Pay directly on this page using your debit card or bank transfer
          ...
          <div className="rounded-[20px] border border-[#E1E7E2] bg-white p-5 shadow-sm">
            ...
            <p className="mt-1 text-xs text-[#5B6B62]">
              Prefer offline? Dial the USSD code on your receipt or use
          ...
          <div className="rounded-[20px] border border-[#E1E7E2] bg-white p-5 shadow-sm">
            ...
            <h3 className="mt-2 font-['Space_Grotesk',sans-serif] text-sm font-semibold text-[#0E1F17]">
              Verified Field Agents
            </h3>
            <p className="mt-1 text-xs text-[#5B6B62]">
              Paying an agent in person? Ask for their agent ID and confirm it
              with our support line first.
            </p>
          </div>
        </div>

        <div className="mt-4 flex flex-col items-start gap-3 rounded-[20px] border border-[#E8A33D]/40 bg-[#E8A33D]/8 p-5 sm:flex-row sm:items-center">
          <Shield className="h-6 w-6 shrink-0 text-[#E8A33D]" />
          <p className="text-sm text-[#0E1F17]/80">
            <span className="font-semibold">Protect yourself:</span> Only make
            payments through this website, our official USSD/bank channels, or
            an agent whose ID you have verified. We will never ask you to send
            money to a personal account, and every genuine payment gets you an
      ...
      >
        <div className="rounded-[20px] border border-[#1B9E5A]/25 bg-[#E4F5EB]/60 p-6 shadow-sm md:p-8">
          <div className="mb-6 text-center">
            ...
            <p className="mx-auto mt-2 max-w-2xl text-sm text-[#5B6B62] md:text-base">
              Check the status of your payment by entering your transaction
              details.
            </p>
          </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-[20px] bg-white p-6 shadow-md">
            <div className="mb-4 flex items-center justify-between">
              <h3 className="font-['Space_Grotesk',sans-serif] text-lg font-bold text-[#0E1F17]">
                Verification Result
              </h3>
              <button
                onClick={() => setShowNotFoundModal(false)}
                className="text-[#5B6B62] hover:text-[#0E1F17]"
              >
                <X className="h-5 w-5" />
              </button>
            </div>
            <div className="mb-6 rounded-2xl border border-red-100 bg-red-50 p-4">
              <p className="text-sm text-red-800">
                No payment with such reference/ID was found. Please check your
                payment reference number or ID and try again.
              </p>
            </div>
            <button
              onClick={() => setShowNotFoundModal(false)}
          ...
          <div className="my-8 flex max-h-[90vh] w-full max-w-2xl flex-col overflow-hidden rounded-[20px] bg-white p-6 shadow-md">
            <div className="mb-4 flex shrink-0 items-center justify-between">
              ...
              <button
                ...
                className="cursor-pointer text-[#5B6B62] hover:text-[#0E1F17]"
              >
                <X className="h-5 w-5" />
              </button>
            </div>
                  ...
                  <div className="grid gap-3 md:grid-cols-2">
                    <div>
                      ...
                      <p className="text-sm font-medium text-[#0E1F17]">
                        {paymentData.member.businessName ||
                          paymentData.member.fullname}
                      </p>
                    </div>
              ...
              <div className="rounded-2xl border border-[#E1E7E2] bg-[#F5F7F5] p-4">
                ...
                <div className="grid gap-3 md:grid-cols-2">
                  <div>
                    ...
                    <p className="font-['JetBrains_Mono',monospace] text-sm font-medium text-[#0E1F17]">
              ...
              <div className="rounded-2xl border border-[#E1E7E2] bg-[#F5F7F5] p-4">
                ...
                <div className="grid gap-3 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-[#0E1F17]">
                      {paymentData.pricing.category}
                    </p>
                  </div>
                  <div>
                    <p className="text-xs text-[#5B6B62]">Amount</p>
                    <p className="text-sm font-medium text-[#0E1F17]">
                      {paymentData.pricing.price}
                    </p>
                  </div>
                  <div>
                    <p className="text-xs text-[#5B6B62]">Code</p>
                    <p className="text-sm font-medium text-[#0E1F17]">
                      {paymentData.pricing.code}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="rounded-2xl border border-[#E1E7E2] bg-[#F5F7F5] p-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {paymentData.sessions.map((session, index) => (
                      <span
                        key={index}
                        className="rounded-lg border border-[#E1E7E2] bg-white px-3 py-1 text-xs font-medium text-[#0E1F17]/80"
                      >
                        {session}
                      </span>
                    ))}
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            },
            {
              icon: Phone,
              title: "Mobile Money",
              desc: "Pay using mobile money platforms",
            },
            {
              icon: Shield,
            ...
            <div
              key={title}
              className="rounded-[20px] border border-[#E1E7E2] bg-white p-5 text-center shadow-sm"
            >
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-[#E4F5EB] text-[#158049]">
                <Icon className="h-6 w-6" />
              </div>
              <h3 className="mt-3 font-['Space_Grotesk',sans-serif] text-base font-semibold text-[#0E1F17]">
                {title}
              </h3>
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pb-14 md:px-6">
        <div className="overflow-hidden rounded-[28px] bg-[#0B3B26] p-6 shadow-sm md:p-8">
          <div className="mb-6 text-center">
            <span className="font-['JetBrains_Mono',monospace] text-xs uppercase tracking-wide text-[#8FE0B4]">
              Protected
            </span>
            <h2 className="mt-2 font-['Space_Grotesk',sans-serif] text-2xl font-bold text-white md:text-3xl">
              Your Security is Our Priority
            </h2>
            <p className="mx-auto mt-2 max-w-2xl text-sm text-white/65 md:text-base">
              We use bank-level security measures to protect your transactions
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                desc: "Receive immediate payment confirmation and receipt.",
              },
              {
                icon: Clock,
                title: "24/7 Available",
                desc: "Make payments anytime, anywhere.",
              },
            ].map(({ icon: Icon, title, desc }) => (
              <div key={title} className="flex gap-4">
                ...
                <div>
                  <h3 className="font-['Space_Grotesk',sans-serif] text-base font-semibold text-white">
                    {title}
                  </h3>
        ...
        <div className="rounded-[20px] border border-[#E1E7E2] bg-white p-6 shadow-sm md:p-8">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-[#E1E7E2] bg-[#F5F7F5] p-6 text-center">
              ...
              <a
                href="mailto:support@abujamunicipal.gov.ng"
                className="mt-3 inline-flex items-center gap-2 text-sm font-semibold text-[#158049] hover:text-[#0B3B26]"
              >
