        ...
        <main>
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-16">
                        ...
                        <div className="w-full lg:w-1/2 order-2">
                            <div className="rounded-lg border border-emerald-200 bg-white p-6 shadow-md">
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <div className="text-xs font-semibold text-emerald-800">PAYMENT OPTIONS</div>
                                </div>
                        ...
                        <div className="w-full lg:w-1/2 text-left order-1">
                            ...
                            <div className="mt-8 flex flex-wrap justify-start gap-4">
                                <Link href="/payment" className="inline-flex items-center gap-2 rounded-xl bg-white px-6 py-3 text-sm font-semibold text-emerald-800 transition-colors hover:bg-emerald-50">
                                    Make Payment
            ...
            <section className="mx-auto w-full max-w-7xl px-4 py-16 md:px-6 md:py-24">
                <div className="mb-10 text-center">
                    <span className="text-xs uppercase tracking-wide text-emerald-800">Payment Options</span>
                ...
                <div className="grid gap-8 md:grid-cols-2 xl:grid-cols-3">
                    ...
                    <div className="rounded-xl border border-emerald-100 bg-white p-6 shadow-sm">
                        <div className="flex items-center justify-center mb-6">
                            <div className="flex h-16 w-16 items-center justify-center rounded-lg bg-emerald-50 text-emerald-800">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-start gap-3">
                                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-emerald-100 text-sm font-bold text-emerald-800">1</div>
                                <div>
                            ...
                            <div className="flex items-start gap-3">
                                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-emerald-100 text-sm font-bold text-emerald-800">2</div>
                                <div>
                            ...
                            <div className="flex items-start gap-3">
                                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-emerald-100 text-sm font-bold text-emerald-800">3</div>
                                <div>
                            ...
                            <div className="flex items-start gap-3">
                                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-emerald-100 text-sm font-bold text-emerald-800">4</div>
                                <div>
                        ...
                        <div className="mt-6 flex items-center justify-center gap-2 text-emerald-800">
            ...
            <section className="mx-auto w-full max-w-7xl px-4 pb-14 md:px-6 md:pb-20">
                <div className="rounded-xl border border-emerald-100 bg-emerald-50/60 p-6 shadow-sm md:p-8">
                    <div className="mb-6 text-center">
                        <span className="text-xs uppercase tracking-wide text-emerald-800">Complete Process</span>
                    ...
                    <div className="grid gap-6 md:grid-cols-5 items-center">
                        <div className="text-center">
                            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-white text-emerald-800 shadow-sm">
            ...
            <section className="mx-auto w-full max-w-7xl px-4 pb-14 md:px-6 md:pb-20">
                <div className="rounded-xl border border-emerald-100 bg-linear-to-br from-emerald-50 to-cyan-50 p-6 shadow-sm md:p-8">
                    <div className="mb-6">
                        <span className="text-xs uppercase tracking-wide text-emerald-800">Verify & Download</span>
                    ...
                    <div className="mt-8 flex flex-wrap justify-center gap-4">
                        <Link href="/payment#verify" className="inline-flex items-center gap-2 rounded-xl bg-emerald-800 px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-emerald-900">
                            Verify Payment
                            <ArrowRight className="h-4 w-4" />
                        </Link>
