...
import { changePassword, forgetPassword } from "@/lib/services/admin";
import { changeStaffPassword, forgetStaffPassword } from "@/lib/services/staff";
...
export default function SecurityPage() {
    ...
    const handlePasswordSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (role === "ADMIN") {
                res = await changePassword(user?.uid, passwordForm.currentPassword, passwordForm.newPassword, passwordForm.confirmPassword);
            } else {
                res = await changeStaffPassword(user?.uid, passwordForm.currentPassword, passwordForm.newPassword, passwordForm.confirmPassword);
            }
    ...
    const handleForgetPassword = async () => {
        ...
        try {
            ...
            if (role === "ADMIN") {
                res = await forgetPassword(user?.uid || "");
            } else {
                res = await forgetStaffPassword(user?.uid || "");
            }
