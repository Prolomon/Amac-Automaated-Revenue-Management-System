      ...
      <div className="rounded-2xl bg-linear-to-r from-emerald-900 via-emerald-800 to-teal-900 p-5 text-white shadow-lg md:p-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <button
              onClick={() => { if (readOnly) return; router.push("/it/terminal/assign"); }}
                ...
                >
                  ...
                  <div className="border-t border-slate-100 bg-slate-50/50 p-4">
                    <div className="grid grid-cols-2 gap-2">
                      <button
                        onClick={() => router.push(`/it/terminal/${cardId}`)}
                      ...
                      {isAssigned ? (
                        ...
                        <button
                          onClick={() => { if (readOnly) return; router.push(`/it/terminal/assign?serial=${encodeURIComponent(term.name)}`); }}
