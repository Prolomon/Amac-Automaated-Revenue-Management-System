...
function DemandDetailPage() {
  ...
  const qrData = `https://urms.afriverge.com/payment/${demand?.payment?.reference}/checkout`;
  ...
  return (
    <div className="min-h-screen bg-white py-8">
      <div className="mx-auto max-w-7xl space-y-4 px-4 md:p-6">
        ...
        {/* Main Document */}
        <div
          className="w-full my-0 mx-auto bg-white p-4 rounded-xl shadow-[0_4px_20px_rgba(15,23,42,0.04),0_1px_3px_rgba(15,23,42,0.02)] box-border relative border border-[#e2e8f0] text-[12px]"
        ...
        >
          ...
          <div className="grid grid-cols-[1.3fr_0.7fr] gap-3 mb-4">
            <div className="space-y-3">
              {/* liability breakdown */}
              <div>
                <div className="text-[11px] uppercase tracking-wider text-[#64748b] font-bold mb-1.5">
              ...
              <div className="border border-[#e2e8f0] rounded-lg p-4 bg-white">
                ...
                <div className="grid grid-cols-[0.7fr_1.3fr] gap-3 mb-2.5 pb-2.5 border-b border-[#e2e8f0]">
                  ...
                  {demand.walletId ? (<div className="text-[#1e293b] font-semibold text-[12px] flex flex-col items-start gap-1">
                    <span>
                      <b>Account Number: </b>
                  ...
                  </div>) : (<div className="text-[#1e293b] font-semibold text-[12px] flex flex-col items-start gap-1">
                    <Link href="/upgrade-account" className="rounded-lg px-4 py-3 bg-emerald-800 text-white">Request Account Upgrade</Link>
                  </div>)}
                </div>
