...
function DemandsListPage() {
  ...
  const updateCenter = (value: string) => {
    ...
    window.history.replaceState(null, "", `/it/demands${qs ? `?${qs}` : ""}`);
  };
        ...
        <div className="flex flex-col gap-4">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-3">
            <select
              ...
              className="w-full rounded-xl border border-slate-300 bg-transparent px-3 py-2.5 text-sm text-slate-600 outline-none transition focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 appearance-none"
            >
