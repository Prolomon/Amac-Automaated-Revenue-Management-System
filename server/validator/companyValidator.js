...
const createCompanySchema = Joi.object({
  ...
  category: Joi.array().items(Joi.string().trim()).required().messages({
    "array.base": "Category must be an array",
    "any.required": "Category is required",
  }),
  zone: Joi.string().min(1).max(120).required().messages({
    "string.base": "Zone must be a string",
    "string.min": "Zone must be at least 1 character long",
    "string.max": "Zone must be at most 120 characters long",
...
const updateCompanySchema = Joi.object({
  ...
  zone: Joi.string().min(1).max(120).optional().messages({
    "string.base": "Zone must be a string",
    "string.min": "Zone must be at least 1 character long",
    "string.max": "Zone must be at most 120 characters long",
  }),
