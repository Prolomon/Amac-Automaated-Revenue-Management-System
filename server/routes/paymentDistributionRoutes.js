...
router.post('/calculate', authMiddleware, roleMiddleware(['admin', "staff"]), calculatePaymentDistribution);

// Get payment distribution with filters (status, date range)
router.post('/calculate-filtered', authMiddleware, roleMiddleware(['admin', "staff"]), getDistributionWithFilters);
